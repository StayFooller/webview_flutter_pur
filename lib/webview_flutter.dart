...
typedef Map CallFlutterCallback(Map map);
...
class WebView extends StatefulWidget {
  ...
  final CallFlutterCallback callFlutter;
...
class _PlatformCallbacksHandler implements WebViewPlatformCallbacksHandler {
  ...
  @override
  Map callFlutter(Map parameters){
    if (_widget.callFlutter != null) {
      return _widget.callFlutter(parameters);
    }
    return {'status':'no implement of callFlutter in dart'};
  }
...
class WebViewController {
  ...
  Future<String> callOrigin(Map parameters) {
    return _webViewPlatformController.callOrigin(parameters);
  }
