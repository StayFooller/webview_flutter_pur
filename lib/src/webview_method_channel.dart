...
class MethodChannelWebViewPlatform implements WebViewPlatformController {
  ...
  Future<dynamic> _onMethodCall(MethodCall call) async {
    if(call.method.contains('flu_')){
      return _platformCallbacksHandler.callFlutter(call.arguments);
    }
    switch (call.method) {
  ...
  @override
  Future<String> callOrigin(Map map)async {
    assert(map != null);
    return _channel.invokeMethod<String>(map['ori_Method'].toString(), map);
  }
